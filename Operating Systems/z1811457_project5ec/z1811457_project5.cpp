...
#include "MemoryChunk.hpp"  //contains the struct for a PageTableEntry
#include "PhysicalMemory.hpp" //contains the class PhysicalMemory
#include "PageTable.hpp"  //contains the class PageTable
